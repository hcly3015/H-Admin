<template>
  <div class="mainlist">
    ...
    >
      ...
      >
        <el-row>
          ...
          <el-form-item
            :label="$t('usermanager.nick')"
            prop="nick"
          >
            <el-input
              v-model="searchForm.nick"
              clearable
              :placeholder="$t('usermanager.nick')"
              style="width:240px;"
            ></el-input>
          </el-form-item>
          <el-form-item
          ...
          <el-form-item
            :label="$t('usermanager.createtime')"
            prop="createtime"
          >
            <el-date-picker
    ...
    <div class="datagridlist">
      ...
      <el-col
        :span="24"
        style="padding: 5px 12px;background-color: #fff;border:1px solid #ebeef5;"
      >
        <el-button
          type="primary"
          icon="el-icon-plus"
      ...
      >
        <el-table-column
          prop="avatar"
          :label="$t('usermanager.headpic')"
          width="120"
        >
          <template slot-scope="scope">
            <img
              :src="(scope.row.avatar!==''&&scope.row.avatar!==undefined)?$Config.serverAddress+scope.row.avatar:''"
              alt=""
        ...
        >
          <template slot-scope="scope">
            <el-tag
              ...
              disable-transitions
            >{{scope.row.sex===1?$t('common.male'):$t('common.female')}}</el-tag>
          </template>
        </el-table-column>
        <el-table-column
          sortable
        ...
        <el-table-column
          prop="remark"
          :label="$t('usermanager.remark')"
        >
        </el-table-column>
        <el-table-column
          fixed="right"
          :label="$t('usermanager.operation')"
          width="120"
        >
          <template slot-scope="scope">
            <el-button
